...
public class MiaAppsflyer {
    private static final String TAG = "MiaAppsflyer";
    private Context context;
    private static MiaAppsflyer MiaAppsflyer;
    public static boolean enableAppsflyer = false;

    public MiaAppsflyer() {
    }

    public static MiaAppsflyer getInstance(){
        if (MiaAppsflyer ==null)
            MiaAppsflyer = new MiaAppsflyer();
        return MiaAppsflyer;
    }
