...
public class AdmobRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final MiaAdPlacerSettings settings;

    private RecyclerView.Adapter adapterOriginal;
    private Activity activity;
    private MiaAdPlacer adPlacer;
    private AdapterDataObserver adapterDataObserver = new AdapterDataObserver();

    public AdmobRecyclerAdapter(MiaAdPlacerSettings settings, RecyclerView.Adapter adapterOriginal, Activity activity) {
        this.adapterOriginal = adapterOriginal;
        this.registerAdapterDataObserver(adapterDataObserver);
        this.activity = activity;
        this.settings = settings;
        adPlacer = new MiaAdPlacer(settings, adapterOriginal, activity);
    }
    ...
    private class MiaViewHolder extends RecyclerView.ViewHolder {
        public MiaViewHolder(@NonNull View itemView) {
            super(itemView);
        }
